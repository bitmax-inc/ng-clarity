...
import { ClarityIcons, timesIcon } from '@bitmax/clr-angular/icon';
import { ClrStandaloneCdkTrapFocus, commonStringsDefault, LARGE_BREAKPOINT } from '@bitmax/clr-angular/utils';
