...
import { AppfxDatagridFiltersModule } from '@bitmax/clr-addons/datagrid-filters';
import { ClrDatagridModule } from '@bitmax/clr-angular/data/datagrid';
import { ClrCheckboxModule, ClrInputModule } from '@bitmax/clr-angular/forms';
import { angleIcon, banIcon, ClarityIcons, ClrIcon, dragHandleIcon, plusIcon } from '@bitmax/clr-angular/icon';
import { ClrDropdownModule } from '@bitmax/clr-angular/popover/dropdown';
import { ClrLoadingModule } from '@bitmax/clr-angular/utils/loading';
